...
Сочетание encoder-decoder и decoder-only постановок с разными механизмами моделирования последовательностей позволяет сравнивать архитектуры по двум признакам: способу передачи информации от исходного текста к переводу и типу блока, который обрабатывает последовательность.
