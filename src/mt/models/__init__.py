...
from mt.tokenizers import TOKENIZER_CLASSES, BaseTokenizer, BilingualBaseTokenizer

from .lstm import LstmSeq2Seq, LuongSeq2Seq
from .mamba import MambaDecoder, MambaSeq2Seq
...
Seq2SeqModels = LstmSeq2Seq | LuongSeq2Seq | MambaSeq2Seq | S4Seq2Seq | MambaDecoder
BilingualModels = MambaDecoder
Models = Seq2SeqModels | BilingualModels
Tokenizers = tuple[BaseTokenizer, BaseTokenizer] | BilingualBaseTokenizer


def load_from_config(
    model_dir: Path,
    load_weights: bool = False,
) -> tuple[Models, Tokenizers, dict[str, Any]]:
